...
def myNetwork():
    ...
    h5 = net.addHost('h5', cls=Host, ip='192.168.1.5', defaultRoute=None)
    h6 = net.addHost('h6', cls=Host, ip='192.168.2.1', defaultRoute=None)
    h7 = net.addHost('h7', cls=Host, ip='192.168.2.2', defaultRoute=None)
    h8 = net.addHost('h8', cls=Host, ip='192.168.2.3', defaultRoute=None)
    h9 = net.addHost('h9', cls=Host, ip='192.168.2.4', defaultRoute=None)
    h10 = net.addHost('h10', cls=Host, ip='192.168.2.5', defaultRoute=None)
    h11 = net.addHost('h11', cls=Host, ip='192.168.3.1', defaultRoute=None)
    h12 = net.addHost('h12', cls=Host, ip='192.168.3.2', defaultRoute=None)
    h13 = net.addHost('h13', cls=Host, ip='192.168.3.3', defaultRoute=None)
    h14 = net.addHost('h14', cls=Host, ip='192.168.3.4', defaultRoute=None)
    h15 = net.addHost('h15', cls=Host, ip='192.168.3.5', defaultRoute=None)
    ...
    s3.cmd('ifconfig s3 192.168.3.10')
    s2.cmd('ifconfig s2 192.168.2.10')
    s1.cmd('ifconfig s1 192.168.1.10')
